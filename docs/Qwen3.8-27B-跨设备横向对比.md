...
| 上下文 | DGX Spark NVFP4 +MTP×3 | **PRO 5000 SGLang NVFP4+DSPARK** | PRO 5000 FP8 | PRO 5000 NVFP4 | PRO 5000 Q6_K | PRO 6000 FP8 | PRO 6000 NVFP4 | PRO 6000 Q6_K |
|---|---|---|---|---|---|---|---|---|
| 短（~1-11K） | ~21 | **85.2** | 37.3 → 43.2 | 49.6 → 63.6 | 39.7 → 61.9 | 52.6 → 95.6 | 58.6 → **100.2** | 55.4 |
...
| **PRO 5000 SGLang NVFP4+DSPARK（γ=7）** | **+72%（49.6→85.2）** | **+68% @148K（71.4，不衰减）** 🏆 | ✅ 唯一长上下文不衰减的投机方案 |
