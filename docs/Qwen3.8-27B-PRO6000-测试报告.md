...
|---|---|---|---|
| ~1.4K | 0.23 s | 6,265 t/s | 39.5 t/s |
| ~29.5K | 4.16 s | 7,100 t/s | 24.5 t/s |
| ~88.8K | 16.5 s | 5,384 t/s | 13.7 t/s |
| ~177.3K | 45.8 s | 3,869 t/s | 8.1 t/s |

### NVFP4+MTP

| Prompt | TTFT | Prefill | Decode |
|---|---|---|---|
| ~1.4K | 0.17 s | 8,941 t/s | 47.3 t/s |
| ~29.5K | 3.11 s | 9,465 t/s | 27.0 t/s |
| ~88.8K | 13.4 s | 6,616 t/s | 14.6 t/s |
| ~177.3K | 39.9 s | 4,447 t/s | 8.7 t/s |

说明：decode 在 200K 级长上下文衰减明显（本模型 64 层中 16 层全注意力随长度增长，
48 层 GDN 线性注意力与长度无关）；prefill 方面 NVFP4 各档快 FP8 约 15~43%。
